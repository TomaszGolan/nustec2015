\begin{tikzpicture}[node distance = 1cm and 1.5cm]
 ...
 \node(rightDown) [below=of rightEmpty, xshift = -0.2cm, yshift = 0.2cm] {\scalebox{0.2}{\input{figures/nucleon}}};

 \node(rightUp) [above=of rightEmpty, xshift = -0.2cm, yshift = 0.2cm] {\scalebox{0.2}{\input{figures/quarks}}};
