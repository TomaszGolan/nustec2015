...
\begin{tikzpicture}
  ...
  \begin{axis}[xlabel = {$x$}, ylabel = {$n / A / \mbox{sum} / \mbox{width}$}, ylabel near ticks, domain=0:1, scale=0.5, axis lines = left, inner axis line style={>=latex}, ymin = 0, ymax = 0.45, xmin = 0, xmax = 1.1]
